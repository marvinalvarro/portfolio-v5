...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/umar-hadyu-al-fajri-a507493aa/?skipRedirect=true/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ahadyuuu__",
    icon: Instagram,
    url: "https://www.instagram.com/ahadyuuu__/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Marvin",
    icon: Youtube,
    url: "https://www.youtube.com/@MarvinAlvarro",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "Marvin",
    icon: Github,
    url: "https://github.com/marvinalvarro",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@marvinalvarro",
    color: "black",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-emerald-500 rounded-full"></span>
        Connect With Me
      </h3>
