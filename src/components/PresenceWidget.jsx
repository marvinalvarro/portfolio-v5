...
export default function PresenceWidget() {
  ...
  const getColors = (type) => {
    const colors = {
      ...
      coding: {
        bg: "from-emerald-500/15 to-emerald-500/10",
        border: "border-blue-500/30",
        text: "text-blue-400",
        badge: "bg-emerald-500/20 border-blue-400/40",
        glow: "shadow-blue-500/20"
      },
      gaming: {
        bg: "from-red-500/15 to-lime-500/10",
      ...
      default: {
        bg: "from-emerald-500/15 to-from-emerald-500-500/10",
